...
function sendShareLandingPage(req, res, { safeLang, question, pageUrl, targetUrl }) {
  ...
  const instructions =
    safeLang === "en"
      ...
      : safeLang === "ar"
      ? "رأيك في 30 ثانية. اسم مستعار + إجابة + نقاش مباشر."
